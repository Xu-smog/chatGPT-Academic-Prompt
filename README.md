...
7. 请你润色这段学术性的文字，请保证润色后的文字还是一个段落。

8. 请你补全[]中的内容。

9. 请你润色这段学术性的文字，注意你只需要修改段落中的字词的使用，使逻辑更加通顺，但是不要改变原文表达的意思。
...
1. 阅读论文“xx”的摘要：[]. 请用两句话总结该论文的主要工作和核心思想，并给出论文的关键词，以便在撰写综述时使用。切勿复制论文的摘要。
...
1. 请你对下面这篇论文“”的摘要进行学术性的评价，请你首先总结论文中的学术成果，然后从方案创新性、写作水平等方面进行客观的评价，不要只给出夸赞，而是要讲出哪些方面写的好，哪些方面不好。请将这些内容写成一个段落。摘要“”
...
1. 你是一名人工智能领域的专业研究者，请你帮我续写一段文章。我将先提供给你这段文章的背景材料。然后你基于我已经写好的内容，进行续写来详细的描述表格中的实验结果。同时你可以对我写的内容进行合理的扩写。请你确保写好的内容逻辑合理、表达清晰。
